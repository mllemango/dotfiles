...
alias d='/opt/dev/bin/dev'
alias g='/nix/var/nix/gcroots/dev-profiles/user-extra-profile/bin/git'
alias op="dev open pr"
alias unbork='bin/rails db:reset RAILS_ENV=test || bin/rails db:cpt_migrate lhm:run:all RAILS_ENV=test'
